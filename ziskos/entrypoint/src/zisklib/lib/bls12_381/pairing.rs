...
pub fn pairing_check_safe_bls12_381(
    ...
    // Collect valid pairs
    let mut valid_g1: Vec<[u64; 12]> = new_scratch_vec(g1_points.len());
    let mut valid_g2: Vec<[u64; 24]> = new_scratch_vec(g2_points.len());
...
pub(crate) unsafe fn pairing_check_safe_bls12_381_c(
    ...
    // Parse all pairs
    let mut g1_points: Vec<[u64; 12]> = new_scratch_vec(num_pairs);
    let mut g2_points: Vec<[u64; 24]> = new_scratch_vec(num_pairs);
